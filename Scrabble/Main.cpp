...
CMain::CMain(int passed_ScreenWidth, int passed_ScreenHeight)
{
	...
	Deck = new CSprite(csdl_setup->GetRenderer(), "data/deck/gamedeck.png", 0, 0, 800, 600, '-', 0);
	Deck2 = new CSprite(csdl_setup->GetRenderer(), "data/deck/gd_plusSwap.png", 0, 0, 800, 600, '-', 0);
	Score = new CScore(csdl_setup);
	Swap = new CSprite(csdl_setup->GetRenderer(), "data/buttons/swap.png", 633, 421, 55, 23, '-', 0);
	Cancel = new CSprite(csdl_setup->GetRenderer(), "data/buttons/cancel.png", 702, 421, 57, 23, '-', 0);
	Pass = new CSprite(csdl_setup->GetRenderer(), "data/buttons/pass.png", 633, 457, 55, 23, '-', 0);
	Undo = new CSprite(csdl_setup->GetRenderer(), "data/buttons/undo.png", 633, 457, 55, 23, '-', 0);
	Play = new CSprite(csdl_setup->GetRenderer(), "data/buttons/play.png", 702, 457, 57, 23, '-', 0);
	Swap2 = new CSprite(csdl_setup->GetRenderer(), "data/buttons/swap2.png", 633, 421, 55, 23, '-', 0);
	Cancel2 = new CSprite(csdl_setup->GetRenderer(), "data/buttons/cancel2.png", 702, 421, 57, 23, '-', 0);
	Pass2 = new CSprite(csdl_setup->GetRenderer(), "data/buttons/pass2.png", 633, 457, 55, 23, '-', 0);
	Undo2 = new CSprite(csdl_setup->GetRenderer(), "data/buttons/undo2.png", 633, 457, 55, 23, '-', 0);
	Play2 = new CSprite(csdl_setup->GetRenderer(), "data/buttons/play2.png", 702, 457, 57, 23, '-', 0);
	...
	CheckWord = new CSprite(csdl_setup->GetRenderer(), "data/buttons/checkWord.png", 608, 532, 93, 23, '-', 0);
	CheckWord2 = new CSprite(csdl_setup->GetRenderer(), "data/buttons/checkWord2.png", 608, 532, 93, 23, '-', 0);
	Wid = new CSprite(csdl_setup->GetRenderer(), "data/buttons/wid.png", 608, 569, 166, 18, '-', 0);
	Wind = new CSprite(csdl_setup->GetRenderer(), "data/buttons/wind.png", 608, 569, 184, 16, '-', 0);
}
...
int CMain::CheckSel()
{
	...
	else if((MouseX >= 633 && MouseX <= 688) && (MouseY >= 457 && MouseY <= 480))
	{
		clickSel = 2;//pass
	}
	/*else if((MouseX >= 633 && MouseX <= 688) && (MouseY >= 457 && MouseY <= 480))
